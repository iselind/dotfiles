...
| [commit_at_stable_points.md](commit_at_stable_points.md) | feedback | Stable point = all verification for the changes being committed passes (may involve tests, kubectl explain, terraform, linting); iterate one change at a time |
