...
Read `gap-discovery.md` (in this skill directory) for the full workflow on
how to assess and apply gap fixes. Work through each identified gap one at a
time per those instructions, then move directly to Phase 4.
